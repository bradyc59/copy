...
public class Shelve {
    ...
    public static List<Books> AddBooksToShelves(Books book) {
    ...
    public static List<Books> StackFictionShelf(Books book) {
    ...
    public static List<Books> StackHorrorShelf(Books book) {
    ...
    public static List<Books> StackCrimeShelf(Books book) {
        // System.out.println(book.toString().equals("Fiction"));
        // System.out.println(book);
        CrimeShelf.add(book);
    ...
    public static List<Books> StackFantasyShelf(Books book) {
    ...
    public static List<Books> StackRomanceShelf(Books book) {
    ...
    public static List<Books> StackSportShelf(Books book) {
